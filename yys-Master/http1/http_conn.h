...
class http_conn
{
    public:
        ...
        //enum的好处比define方便，不重复的宏，都是整型的宏。而define可以定义任何类型，enum类型安全的，define不安全
        //请求方法
        enum METHOD{
...
public:
    ...
    private:
        ...
        //客户请求的目标文件的完整路经，其内容等于doc_root + m_url,doc_root是网站的根目录
        char m_read_file[ FILENAME_LEN ];
        //客户请求的目标文件名
        char* m_url;
        //HTTP协议的版本号,仅支持HTTP/1.1
        char *m_version;
        //主机名
        char *m_host;
        //HTTP请求的消息体的长度
